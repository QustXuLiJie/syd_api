...
public enum BorrowStatusEnum {
    ...
    public static BorrowStatusEnum getByStatus(String status) {
    ...
    BorrowStatusEnum(String statusCode, String statusMsg) {
        this.statusCode = statusCode;
        this.statusMsg = statusMsg;
    }

    BorrowStatusEnum(String statusCode, String statusMsg, String statusTitle, String statusDisplay, String fixMsg) {
        this.statusCode = statusCode;
        this.statusMsg = statusMsg;
